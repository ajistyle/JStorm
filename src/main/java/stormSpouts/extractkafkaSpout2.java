 ...
 * @since 1.0.0
 */
public class extractkafkaSpout2 implements IRichSpout {
    ...
    public void open(Map map, TopologyContext topologyContext, SpoutOutputCollector spoutOutputCollector) {
        ...
        ConsumerGroup consumerGroup = new ConsumerGroup(KafkaProperties.brokers,KafkaProperties.groupId,KafkaProperties.topic2,3);
        consumerGroup.start();
